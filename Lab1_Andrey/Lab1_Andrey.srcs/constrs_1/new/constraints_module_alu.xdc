...
set_property PACKAGE_PIN U9 [get_ports {sw_ALUControl_pi[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_ALUControl_pi[0]}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {sw_ALUControl_pi[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_ALUControl_pi[1]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {sw_ALUControl_pi[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_ALUControl_pi[2]}]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports {sw_ALUControl_pi[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_ALUControl_pi[3]}]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
#set_property PACKAGE_PIN R5 [get_ports {sw[]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {sw[]}]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
set_property PACKAGE_PIN V7 [get_ports {sw_ALUFlagIn_pi}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_ALUFlagIn_pi}]
##Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
#set_property PACKAGE_PIN V6 [get_ports {sw[6]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {sw[6]}]
##Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
set_property PACKAGE_PIN V5 [get_ports {sw_ALUB_pi[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_ALUB_pi[0]}]
##Bank = 34, Pin name = IO_L8P_T1-34,						Sch name = SW8
set_property PACKAGE_PIN U4 [get_ports {sw_ALUB_pi[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_ALUB_pi[1]}]
##Bank = 34, Pin name = IO_L9N_T1_DQS_34,					Sch name = SW9
set_property PACKAGE_PIN V2 [get_ports {sw_ALUB_pi[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_ALUB_pi[2]}]
##Bank = 34, Pin name = IO_L9P_T1_DQS_34,					Sch name = SW10
set_property PACKAGE_PIN U2 [get_ports {sw_ALUB_pi[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_ALUB_pi[3]}]
##Bank = 34, Pin name = IO_L11N_T1_MRCC_34,					Sch name = SW11
#set_property PACKAGE_PIN T3 [get_ports {sw_ALUB_pi[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {sw_ALUB_pi[0]}]
##Bank = 34, Pin name = IO_L17N_T2_34,						Sch name = SW12
set_property PACKAGE_PIN T1 [get_ports {sw_ALUA_pi[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_ALUA_pi[0]}]
##Bank = 34, Pin name = IO_L11P_T1_SRCC_34,					Sch name = SW13
set_property PACKAGE_PIN R3 [get_ports {sw_ALUA_pi[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_ALUA_pi[1]}]
##Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = SW14
set_property PACKAGE_PIN P3 [get_ports {sw_ALUA_pi[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_ALUA_pi[2]}]
##Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = SW15
set_property PACKAGE_PIN P4 [get_ports {sw_ALUA_pi[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_ALUA_pi[3]}]
...
set_property PACKAGE_PIN N6 [get_ports {anodo_po[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {anodo_po[0]}]
##Bank = 34, Pin name = IO_L18P_T2_34,						Sch name = AN1
set_property PACKAGE_PIN M6 [get_ports {anodo_po[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {anodo_po[1]}]
##Bank = 34, Pin name = IO_L4P_T0_34,						Sch name = AN2
set_property PACKAGE_PIN M3 [get_ports {anodo_po[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {anodo_po[2]}]
##Bank = 34, Pin name = IO_L13_T2_MRCC_34,					Sch name = AN3
set_property PACKAGE_PIN N5 [get_ports {anodo_po[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {anodo_po[3]}]
##Bank = 34, Pin name = IO_L3P_T0_DQS_34,					Sch name = AN4
set_property PACKAGE_PIN N2 [get_ports {anodo_po[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {anodo_po[4]}]
##Bank = 34, Pin name = IO_L16N_T2_34,						Sch name = AN5
set_property PACKAGE_PIN N4 [get_ports {anodo_po[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {anodo_po[5]}]
##Bank = 34, Pin name = IO_L1P_T0_34,						Sch name = AN6
set_property PACKAGE_PIN L1 [get_ports {anodo_po[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {anodo_po[6]}]
##Bank = 34, Pin name = IO_L1N_T034,							Sch name = AN7
set_property PACKAGE_PIN M1 [get_ports {anodo_po[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {anodo_po[7]}]
...
set_property PACKAGE_PIN T16 [get_ports btn_pi[1]]						
	set_property IOSTANDARD LVCMOS33 [get_ports btn_pi[1]]
##Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
set_property PACKAGE_PIN R10 [get_ports btn_pi[0]]						
	set_property IOSTANDARD LVCMOS33 [get_ports btn_pi[0]]
