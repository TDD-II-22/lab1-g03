...
synth_design -top module_alu_fpga -part xc7a100tcsg324-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef module_alu_fpga.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file module_alu_fpga_utilization_synth.rpt -pb module_alu_fpga_utilization_synth.pb"
