...
HD_PWD='C:/TDD/lab1-g03/vivado_project/vivado_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log module_mux4a1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source module_mux4a1.tcl -notrace
