...
synth_design -top module_mux4a1 -part xc7a100tcsg324-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef module_mux4a1.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file module_mux4a1_utilization_synth.rpt -pb module_mux4a1_utilization_synth.pb"
