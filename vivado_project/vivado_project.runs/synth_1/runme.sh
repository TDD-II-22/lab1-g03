...
HD_PWD='D:/VIVADO/GR3/lab1-g03/vivado_project/vivado_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log module_mux4a1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source module_mux4a1.tcl
